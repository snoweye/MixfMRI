...
lmt.pv <- function(fcobj.0, fcobj.a, X.gbd, PV.gbd, tau = 0.5,
  ...
  E.delta <- get.E.delta.pv(x, fcobj.0, fcobj.a, tau = tau, n.mc = n.mc.E.delta)

  ### Chi-squared statistics
  E.chi2.0 <- get.E.chi2.pv(x, fcobj.0, fcobj.a, "0", tau = tau,
                            n.mc = n.mc.E.chi2, verbose = verbose)
  E.chi2.a <- get.E.chi2.pv(x, fcobj.0, fcobj.a, "a", tau = tau,
                            n.mc = n.mc.E.chi2, verbose = verbose)
...
print.lmt.pv <- function(x, digits = max(4, getOption("digits") - 3), ...){
  K.0 <- x$K.0
  K.a <- x$K.a
  ll.0 <- x$ll.0
  ll.a <- x$ll.a
